...
from dotenv import load_dotenv # we use it for loading environment variables secrets and stuff.
...
# The code above initializes a simple agent that processes human messages using a GPT-4.1 nano model.
